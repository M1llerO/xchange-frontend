...
const ERROR_MESSAGES_IT: Record<string, string> = {
  ...
  logistics_not_set: 'Imposta prima il luogo, la fascia oraria e il metodo di scambio.',
  logistics_not_confirmed: 'Entrambe le parti devono prima confermare luogo, fascia oraria e metodo di scambio.'
};
